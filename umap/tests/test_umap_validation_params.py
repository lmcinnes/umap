...
sections (highlighted with comments), depending on
the specific set of UMAP features under test.
Each section include a set of utility functions -
defined on top of each section - which have been included
to remove all the code clones (repetitions),
and so make the testing code easier to maintain.
"""
