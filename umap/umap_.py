...
from umap.utils import tau_rand_int, deheap_sort, seed, submatrix, ts
...
def optimize_layout(
    ...
    with joblib.Parallel(prefer="threads", n_jobs=n_jobs) as parallel:
        for n in range(n_epochs):
            _optimize_layout_single_epoch_joblib(head_embedding,
                                                 tail_embedding,
                                                 head,
                                                 tail,
                                                 n_vertices,
...
def _optimize_layout_single_epoch_subrange(
    head_embedding,
    tail_embedding,
    head,
    tail,
...
def _optimize_layout_single_epoch_joblib(
    head_embedding,
    tail_embedding,
    head,
    tail,
    ...
    def inner_fn(index):
        ...
        _optimize_layout_single_epoch_subrange(head_embedding,
                                               tail_embedding,
                                               head,
                                               tail,
                                               n_vertices,
